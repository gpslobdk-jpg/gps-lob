...
export default function EnglishAiInterviewModal({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.16),transparent_30%),radial-gradient(circle_at_bottom,rgba(239,68,68,0.12),transparent_34%)]" />
        ...
        <div className="mx-auto w-full max-w-5xl text-center">
          <div className="flex items-center justify-between gap-4 text-xs font-semibold tracking-[0.24em] text-slate-400 uppercase">
            ...
            <span className="inline-flex items-center gap-2 text-blue-100">
              <span className="relative inline-flex h-9 w-9 items-center justify-center overflow-hidden rounded-[1.05rem] border border-white/85 bg-white p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.94),inset_0_-6px_12px_rgba(30,64,175,0.08),0_16px_34px_rgba(255,255,255,0.12),0_14px_28px_rgba(59,130,246,0.28)] ring-1 ring-blue-200/45">
                <span
                  aria-hidden="true"
          ...
          <div className="mt-10 rounded-4xl border border-white/10 bg-white/3 px-6 py-10 shadow-[0_30px_100px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:px-10 sm:py-14">
            {step === 1 ? (
              <>
                <p className="text-sm font-semibold tracking-[0.28em] text-red-300 uppercase">Trin 1</p>
                <h2
                ...
                >
                  <span className="relative inline-flex h-[4.8rem] w-[4.8rem] items-center justify-center overflow-hidden rounded-[1.8rem] border border-white/90 bg-white p-2.5 text-blue-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.95),inset_0_-8px_16px_rgba(30,64,175,0.08),0_24px_52px_rgba(255,255,255,0.14),0_18px_42px_rgba(59,130,246,0.3)] ring-1 ring-blue-200/55 sm:h-[5.3rem] sm:w-[5.3rem]">
                    <span
                      aria-hidden="true"
                ...
                <div className="mx-auto mt-10 grid w-full grid-cols-2 gap-4 sm:grid-cols-3 xl:grid-cols-4">
                  {GRADE_LEVEL_OPTIONS.map((option) => (
                    <button
                      ...
                      className="w-full rounded-[1.6rem] border border-white/10 bg-white/4 px-5 py-5 text-base font-semibold text-white transition hover:border-red-300/40 hover:bg-red-500/12"
                    >
                      {option}
                    </button>
                  ))}
            ...
            {step === 2 ? (
              <>
                <p className="text-sm font-semibold tracking-[0.28em] text-red-300 uppercase">Trin 2</p>
                <h2
                  id="engelsk-ai-interview-title"
                ...
                <textarea
                  ...
                  className="mt-10 w-full rounded-[1.8rem] border border-white/10 bg-slate-950/90 px-6 py-5 text-left text-lg text-white placeholder:text-slate-500 focus:border-red-400 focus:outline-none focus:ring-2 focus:ring-red-400/50"
                />
                  ...
                  <div className="mt-6 flex w-full flex-wrap justify-start gap-3">
                    {topicSuggestions.map((suggestion) => (
                      <button
                        ...
                        className="rounded-full border border-white/10 bg-white/4 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-red-300/40 hover:bg-red-500/12"
                      >
                        {suggestion}
                      </button>
                    ))}
                ...
                <div className="mt-10 flex items-center justify-center gap-6">
                  ...
                  <button
                    ...
                    className="inline-flex min-w-55 items-center justify-center rounded-[1.4rem] border border-red-300/30 bg-red-500 px-8 py-4 text-lg font-bold text-slate-950 transition hover:bg-red-300 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    Næste
                  </button>
                </div>
            ...
            {step === 3 ? (
              <>
                <p className="text-sm font-semibold tracking-[0.28em] text-red-300 uppercase">Trin 3</p>
                <h2
                  id="engelsk-ai-interview-title"
                  className={`mt-5 text-4xl font-black tracking-tight text-white sm:text-6xl ${rubik.className}`}
                >
                ...
                <div className="mx-auto mt-10 grid w-full gap-4 md:grid-cols-3">
                  {QUESTION_COUNT_OPTIONS.map((countOption) => (
                    <button
                      ...
                      className="w-full rounded-[1.6rem] border border-white/10 bg-white/4 px-6 py-5 text-lg font-semibold text-white transition hover:border-red-300/40 hover:bg-red-500/12"
                    >
                      {countOption} poster
                    </button>
                  ))}
            ...
            {step === 4 ? (
              <div className="flex min-h-96 flex-col items-center justify-center">
                <div className="rounded-full border border-red-400/20 bg-red-500/12 p-6 text-red-300">
                  <Loader2 className="h-10 w-10 animate-spin" />
                </div>
                <p className="mt-8 text-sm font-semibold tracking-[0.28em] text-red-300 uppercase">Trin 4</p>
                <h2
                  id="engelsk-ai-interview-title"
                  className={`mt-5 text-4xl font-black tracking-tight text-white sm:text-6xl ${rubik.className}`}
                >
