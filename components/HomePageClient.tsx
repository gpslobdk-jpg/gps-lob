...
export default function HomePageClient({ isNativeGpslobApp }: HomePageClientProps) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden text-slate-100">
      ...
      <section className="relative z-20 mx-auto w-full max-w-4xl px-4 pb-6 md:px-6 md:pb-8">
        <div className="overflow-hidden rounded-4xl border border-emerald-500/70 bg-emerald-600 text-white shadow-[0_24px_60px_rgba(5,150,105,0.35)]">
          <div className="grid gap-8 px-6 py-7 sm:px-8 sm:py-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:px-10 lg:py-10">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/18 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-sm font-black text-white">Ingen elev-logins</p>
                <p className="mt-2 text-sm leading-6 text-white/88">
                  Eleverne skal ikke oprette en konto, afgive mailadresser eller downloade en app.
                </p>
              </div>
              <div className="rounded-3xl border border-white/18 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-sm font-black text-white">Intet UNI-login</p>
                <p className="mt-2 text-sm leading-6 text-white/88">
                  Eleverne har direkte adgang via browseren.
                </p>
              </div>
              <div className="rounded-3xl border border-white/18 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-sm font-black text-white">Fuld anonymitet</p>
                <p className="mt-2 text-sm leading-6 text-white/88">
                  De indtaster udelukkende løbets pinkode og et valgfrit holdnavn (f.eks. &quot;Hold 3&quot;).
                </p>
              </div>
              <div className="rounded-3xl border border-white/18 bg-white/10 p-4 backdrop-blur-sm">
                <p className="text-sm font-black text-white">Tryg datahåndtering</p>
                <p className="mt-2 text-sm leading-6 text-white/88">
                  Vi sporer ingen personfølsomme oplysninger. Data bruges udelukkende til at afvikle det aktive stjerneløb og vises kun på lærerens skærm.
                </p>
              </div>
            </div>
          </div>
