    ...
    <main className="flex min-h-svh items-center justify-center bg-slate-950 px-5 py-10 text-white">
      <section className="w-full max-w-md rounded-[2rem] border border-white/10 bg-slate-900 p-7 text-center shadow-2xl sm:p-9">
        ...
        <div className="mt-7 grid gap-3">
          <a
            href="/join"
            className="inline-flex min-h-14 items-center justify-center rounded-2xl bg-[#0b5ed7] px-5 py-3 text-base font-black text-white transition hover:bg-[#0a52be] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-sky-200"
          >
            Prøv igen
          </a>
          <a
