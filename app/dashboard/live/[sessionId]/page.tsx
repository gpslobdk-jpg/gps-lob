    ...
    <AnimatePresence mode="wait">
      {status === "waiting" ? (
        <motion.main
          ...
          className={`relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-t from-emerald-100 via-sky-50 to-sky-300 p-6 text-white md:p-12 lg:bg-none lg:bg-transparent ${poppins.className}`}
        >
          <video
            autoPlay
            loop
