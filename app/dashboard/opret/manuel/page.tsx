  ...
  return value
    .map((item, index): Question | null => {
      ...
      return {
        ...
        answers,
        correctIndex: safeCorrectIndex,
        lat: asNumberOrNull(candidate.lat) ?? AUTO_GENERATED_RUN_CENTER.lat,
        lng: asNumberOrNull(candidate.lng) ?? AUTO_GENERATED_RUN_CENTER.lng,
      };
    })
    .filter((question): question is Question => question !== null);
}
...
function OpretLoebPageContent() {
  ...
  const handleSubmitAutoGenerateRun = async () => {
    ...
    try {
      ...
      const firstPinnedQuestion =
        nextQuestions.find((question) => question.lat !== null && question.lng !== null) ?? null;
      ...
      setMapCenter(
        firstPinnedQuestion
          ? {
              lat: firstPinnedQuestion.lat ?? AUTO_GENERATED_RUN_CENTER.lat,
              lng: firstPinnedQuestion.lng ?? AUTO_GENERATED_RUN_CENTER.lng,
            }
          : AUTO_GENERATED_RUN_CENTER
      );
