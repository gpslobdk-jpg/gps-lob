                  ...
                  <div className="relative z-40 mb-8 space-y-5">
                    ...
                    <div className="relative z-40 rounded-4xl border border-indigo-500/35 bg-slate-950/55 p-5 shadow-[0_18px_40px_rgba(0,0,0,0.24)] backdrop-blur-2xl sm:p-6">
                      <div className="flex flex-col gap-4">
                          ...
                          <div className="flex flex-wrap items-center gap-2 print:hidden">
                            <span
                              className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-semibold backdrop-blur-xl ${
                                isSaving
                                  ? "border-indigo-300/35 bg-indigo-400/10 text-white"
                                  : "border-indigo-500/20 bg-slate-950/45 text-indigo-100/72"
                              }`}
                            >
                              {isSaving ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <span className="h-2 w-2 rounded-full bg-indigo-300/70" />}
                              {builderStatusLabel}
                            </span>
                        ...
                        <p className="text-sm leading-6 text-indigo-100/68">{builderStatusDescription}</p>
                      </div>
                    </div>
                  </div>
