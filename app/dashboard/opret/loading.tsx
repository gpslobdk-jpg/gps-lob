export default function Loading() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-sky-300 via-emerald-50 to-emerald-200 p-6 text-emerald-900">
      <div className="rounded-3xl bg-white/95 p-8 shadow-xl backdrop-blur-md flex flex-col items-center gap-4">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="animate-spin h-10 w-10 text-emerald-700"
        >
