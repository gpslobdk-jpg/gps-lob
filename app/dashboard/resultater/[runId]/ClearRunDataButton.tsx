...
function SubmitButton({ disabled }: { disabled: boolean }) {
  ...
  return (
    ...
    >
      ...
      {pending ? "RYDDER DATA..." : "Ryd alle billeder, besvarelser og data for dette løb"}
    </button>
  );
}
    ...
    <form
      ...
      onSubmit={(event) => {
        const confirmed = window.confirm(
          "Er du sikker på, at du vil slette alle gemte billeder, besvarelser, deltagerspor og live-sessioner for dette løb?"
        );
